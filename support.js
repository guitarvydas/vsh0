...
//     var len = s.length;
//     if (s[0] !== '"') {
// 	throw "string 0 is not a quote";
//     }
//     if (s[len-1] !== '"') {
// 	throw "string len-1 is not a quote";
//     }
//     let contents = s.substring (1,len-1);
//     let encodedS = encodeURI (contents);
//     return '"' + encodedS.replace (/[\r\n]/g,'%0A') + '"';
// }

// exports.encodeString = function (s) {
//     let es = encodeString (s);
//     console.error (s);
//     console.error (es);
//     return encodeString (es);
// }
